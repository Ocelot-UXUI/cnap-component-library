# CNAP Frontend — Claude Code Instructions

## First Rule

每次开始对话时，首先读取项目根目录下的 `AGENTS.md` 文件。

## Critical References（编写代码前必读）

- `AGENTS.md` — 项目 AGE 工作流、任务路由、规范总入口
...
- antd 组件通过 `themePresets.cnap2` 应用主题，不在业务组件内覆盖 antd token。
