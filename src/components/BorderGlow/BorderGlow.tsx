...
import {type CSSProperties, type FC, type ReactNode, useCallback, useEffect, useRef} from 'react';
...
const BorderGlow: FC<BorderGlowProps> = ({
    ...
    useEffect(
        () => {
            ...
            const handleMouseLeave = () => card.style.setProperty('--edge-proximity', '0');
    ...
    return (
        <div
            ref={cardRef}
            className={`border-glow-card${lightMode ? ' light-mode' : ''} ${className}`}
            style={{
