...
CNAP frontend uses calibrated prompts under `docs/skills/`. Apply the project calibration in `docs/skills/README.md`, especially protected areas (`auth/login`, `UserContext`, `executor`, `capabilities`), verification stack, and known risk areas.
