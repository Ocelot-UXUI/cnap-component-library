...
- `2026-08-03-global-modal-drawer-registry-plan.md` - planned（暂挂起）; 全局弹窗/抽屉注册与调用机制（req 2 前置）
- `2026-08-03-pod-detail-drawer-ops-standalone-page-plan.md` - proposed（暂挂起，依赖上一份）; Pod 详情 Drawer 操作列表 + 独立页面（req 2）
...
- `2026-08-03-workloads-detail-optimizations-plan.md` - completed; Workloads 细节优化（版本截断 / 弹窗默认选择 / Group 操作列表），req 1+3+4（独立 closure audit 通过）
